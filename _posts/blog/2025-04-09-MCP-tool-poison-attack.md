...
POC의 시나리오는 이렇습니다. 일반 사용자가 2개의 MCP Server를 사용하고자 구축해둔 상황이며, 해당 취약점을 이용해 `악성 MCP Server`가 `신뢰할 수 있는 MCP Server`의 Tool을 호출하도록 해보았어요.
...
![2025-04-10-mcp-poison-attack1.png](/posts/2025-04-10-mcp-poison-attack1.png)
